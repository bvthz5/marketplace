...
namespace MarketplaceAdminTest.Data
{
    public class NotificationRepositoryTest
    {
        ...
        {
            _dbContext = new MarketPlaceDbContext(new DbContextOptionsBuilder<MarketPlaceDbContext>().UseInMemoryDatabase(databaseName: "TestDatabaseNotification").Options);
        ...
        public async Task Add_ValidNotification_ShouldAddAndReturnNotification()
        {
            ...
            Assert.Equal(notification.Status, _dbContext.Notifications.FirstOrDefault(notification => notification.Data == notification.Data)?.Status);
        }
